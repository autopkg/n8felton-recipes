...
"""See docstring for FijiVersionFixer class"""
...
__all__ = ["FijiVersionFixer"]


class FijiVersionFixer(Processor):
    """Fixes Fiji version string."""
    description = __doc__
    input_variables = {
        "app_path": {
            "required": True,
            "description": "Path to Fiji.app.",
        },
        "version": {
            "required": True,
            "description": "Version of Fiji.app",
        },
    }
    output_variables = {
        "bundleid": {
            "description": "Bundle identifier of Fiji.app.",
        },
        "version": {
            "description": "Version of Fiji.app.",
        },
    ...
    def main(self):
        ...
        info["CFBundleGetInfoString"] = self.env["version"]
        self.write_bundle_info(info, app_path)


if __name__ == '__main__':
    PROCESSOR = FijiVersionFixer()
